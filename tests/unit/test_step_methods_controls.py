...
def test_step_handler_email_with_control_schema():
...
def test_step_handler_in_app_with_control_schema():
...
def test_step_handler_sms_with_control_schema():
...
def test_step_handler_push_with_control_schema():
...
def test_step_methods_without_control_schema():
    ...
    handler.email("test-email", resolver_no_controls)
